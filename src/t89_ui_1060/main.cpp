/*
 * t89_ui_1060 — the real T89 dashboard (SquareLine screens, DSEG fonts,
 * GaugeUpdater) on the Guition JC1060P470C-I-W-Y ESP32-P4 7" board, driven by
 * the LVGL 9 glue (partial rendering straight into a 1024x600 landscape
 * framebuffer — this glass needs no rotation).
 *
 * This is the CAR display. Its 4.3" sibling in src/t89_ui is the test-rig
 * display; the two trees are kept deliberately parallel so they stay easy to
 * diff. The layout is the same design scaled 1.25x — see ui_scale.h.
 *
...
#include "lvgl_glue.h"
#include "ui.h"
#include "ui_scale.h"   /* 1.25x layout scale — must follow ui.h; see the header */
