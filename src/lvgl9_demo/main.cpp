 ...
 * builds a tiny UI: a centered label "JC4880P4 LVGL9" and a button that logs each
 * press over Serial.
 *
...
static void btn_event_cb(lv_event_t *e)
{
    ...
    s_press_count++;
    Serial.printf("[Lvgl9Ui] button pressed (#%lu)\n", (unsigned long)s_press_count);
    if (label) {
...
static void build_ui(void)
{
    ...
    lv_label_set_text(title, "JC4880P4 LVGL9");
...
void setup(void)
{
    ...
    Serial.println("[Lvgl9Ui] ready — tap the button");
}
